  ...
  return (
    <div id="home" className="w-full">
      <div className="relative w-full overflow-hidden h-screen min-h-[600px]">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-[#250950]/80 via-[#54428e]/70 to-[#f66d9d]/40 flex flex-col items-center justify-center px-6">
          <div className="text-center max-w-5xl flex-1 flex flex-col items-center justify-center">
            <h1 className="text-5xl md:text-7xl lg:text-9xl text-[#FEFEFE] font-black mb-6 tracking-tight drop-shadow-lg">
              {content.jumbotron.title}
            </h1>
            <p className="text-xl md:text-2xl lg:text-3xl text-[#FEFEFE]/95 font-light drop-shadow-md mb-6">
              {content.jumbotron.description}
            </p>
            <p className="text-base md:text-lg lg:text-xl text-[#FEFEFE]/90 max-w-3xl leading-relaxed drop-shadow-md">
